"use client"
import { useGetSinglePayment, useVerifyPaypalPayment, useVerifyStripePayment } from "@/src/hooks/payment.hook";
...
const PaymentSuccessPage = () => {
  ...
  const { data: payment, isLoading, isError } = useGetSinglePayment(paymentId as string);
  ...
  <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
    <div className="max-w-md w-full text-center">
      ...
      <p className="text-gray-600">Please wait while we confirm your transaction. This won’t take long.</p>
    </div>
  </div>
);
