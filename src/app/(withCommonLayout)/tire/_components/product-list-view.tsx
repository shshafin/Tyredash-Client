    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl transition-all duration-300 group flex flex-col sm:flex-row">
        <div className="relative w-full sm:w-1/3 sm:max-w-[280px]">
          <div ref={sliderRef} className="keen-slider h-[220px] bg-gray-100 dark:bg-gray-900">
          ...
          <div className="absolute top-2 left-2">
            <div className="bg-red-500 text-white text-xs font-bold px-2.5 py-1 rounded-full shadow-md">-20%</div>
          </div>
        </div>
        ...
        <div className="p-5 flex-grow flex flex-col">
          ...
          <h3 className="font-medium text-lg line-clamp-1 mb-2 text-gray-900 dark:text-gray-100">{tire.name}</h3>

          <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-3 mb-4 flex-grow">{tire.description}</p>
          ...
          <div className="flex items-center justify-between mt-auto pt-2">
            <div className="flex flex-col">
              ...
              <span className="text-lg font-bold text-gray-900 dark:text-white">${tire.price.toFixed(2)}</span>
            </div>
            <div className="flex gap-2">
